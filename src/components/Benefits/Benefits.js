                ...
                <div >
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-5 col-xl-6">
                            ...
                            <h2 className='h2Regular bodyTypoColor pb-4 animate__animated animate__pulse text-sm-center text-lg-left animatedhover'>NEUROPROTECTOR</h2>
                            <h2 className='h2Regular bodyTypoColor pb-4 animate__animated animate__pulse text-sm-center text-lg-left animatedhover'>ANTIOXIDANTE Y</h2>
                            <h2 className='h2Regular bodyTypoColor pb-4 animate__animated animate__pulse text-sm-center text-lg-left animatedhover'>ANTIINFLAMATORIO</h2>
